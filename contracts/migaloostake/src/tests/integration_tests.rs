...
use migaloo_destinations::comp_prefs::MigalooDestinationProjectAddresses;
    ...
    let _contract = OutpostContract::instantiate(
        ...
        &InstantiateMsg {
            ...
            project_addresses: ContractAddresses {
                ...
                usdc: AssetInfo::NativeToken { denom: "".to_string() },
                authzpp: AuthzppAddresses::default(),
                destination_projects: MigalooDestinationProjectAddresses::default(),
            },
        },
    )
    .unwrap();
